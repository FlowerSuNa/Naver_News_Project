...
# end if
                    ...
                    test<-test[-grep("img",test)]
                    test<-test[grep("ë©ì¸?´?¤",test):grep("?´?¤ë¦¬ì¤?¸",test)[2]]
...
# end if
                            ...
                            if(ncnt==3)
                            ...
                            else
                                {
                                    ...
                                    postTime<-tst[grep("ê¸°ì¬?? ¥",tst)]
                                    chgTime<-tst[grep("ìµì¢?? ",tst)]
                                    if(length(grep("ë³¸ë¬¸ ?´?©",tst))>1)
                                        {
                                            con<-tst[grep("ë³¸ë¬¸ ?´?©",tst)[1]:grep("ë³¸ë¬¸ ?´?©",tst)[2]]
                                        }
                                    else
                                        {
                                            con<-tst[grep("[(ê°-?£?±-??-?£)]",tst)[ grep("[(ê°-?£?±-??-?£)]",tst)>grep("ë³¸ë¬¸ ?´?©",tst)][1]]
                                        }
# end if
...
# end if
                            ...
                            if(ncnt==3)
                            ...
                            else
                                {
                                    ...
                                    title<-tst[grep("og:title",tst)]
                                    author<-tst[grep(":author\"",tst)]
                                    postTime<-tst[grep("ê¸°ì¬?? ¥",tst)+1]
                                    chgTime<-tst[grep("ìµì¢?? ",tst)]
                                    if(length(grep("ê¸°ì¬ ?´?©",tst))>1)
                                        {
                                            con<-tst[grep("ê¸°ì¬ ?´?©",tst)[1]:grep("ê¸°ì¬ ?´?©",tst)[2]]
                                        }
                                    else
                                        {
                                            con<-tst[grep("[(ê°-?£?±-??-?£)]",tst)[ grep("[(ê°-?£?±-??-?£)]",tst)>grep("ê¸°ì¬ ?´?©",tst)][1]]
                                        }
# end if
